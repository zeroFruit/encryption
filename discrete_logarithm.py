...
if __name__ == "__main__":
    ...
    print("modular exponentiation: %d" % modular_exponentiation(5, 948603, 9048610007))

    # the inverse operation is extremely slow
    print("discrete logarithm: %d" % discrete_logarithm(3668993056, 5, 9048610007))